...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'title must Be No tEmpty' }),
...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'authorPostsId must Be No tEmpty' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CreatePostDto.prototype, "authorPostsId", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'categoryId must Be No tEmpty' }),
